...
import './skills.css';
import UIDesign from '../../Assets1/ui-design.png';
import WebDesign from '../../Assets1/website-design.png';
import AppDesign from '../../Assets1/app-design.png';

const Skills = () => {
  return (
    <section id='skills'>
        <span className="skillTitle">What I do</span>
        <span className="skillDesc">I am a skilled and passionate web designer with experience in creating and user-friendly websites. I have a strong understandin of design and a keen eye for detail. I am proficient in HTML, CSS, and JavaScript, as well as design software such as Adobe Photoshope and Illustrator.</span>
